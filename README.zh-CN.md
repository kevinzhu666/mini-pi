...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 760" width="960" height="760" style="width:100%;max-width:960px;height:auto;">
  ...
  <text x="480" y="36" text-anchor="middle" fill="#111827" font-size="18" font-weight="600" data-graph-role="label">Mini Pi 分层架构</text>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="114" text-anchor="middle" fill="#6b7280" font-size="12.5">参数解析 · 模式选择（交互式 / 单次 / 管道输入）</text>
    <text x="480.0" y="134" text-anchor="middle" fill="#6b7280" font-size="12.5">加载配置与密钥 · 应用 CLI 覆盖</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="236" text-anchor="middle" fill="#6b7280" font-size="12.5">readline 界面 · 斜杠命令 · 记忆 → 系统提示词</text>
    <text x="480.0" y="256" text-anchor="middle" fill="#6b7280" font-size="12.5">会话持久化 · 流式渲染</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="358" text-anchor="middle" fill="#6b7280" font-size="12.5">状态（提示词 / 模型 / 工具 / 消息）· 事件系统</text>
    <text x="480.0" y="378" text-anchor="middle" fill="#6b7280" font-size="12.5">steering / follow-up 队列 · 生命周期</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="458" text-anchor="middle" fill="#111827" font-size="15" font-weight="600">Agent Loop (agent-loop.ts) — 执行引擎</text>
    <text x="480.0" y="480" text-anchor="middle" fill="#6b7280" font-size="12.5">convertToLlm → 流式 LLM → 执行工具</text>
    <text x="480.0" y="500" text-anchor="middle" fill="#6b7280" font-size="12.5">循环直到模型停止</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="325.0" y="602" text-anchor="middle" fill="#6b7280" font-size="12.5">OpenAI 兼容</text>
  ...
  <g data-graph-role="node">
    ...
    <text x="325.0" y="722" text-anchor="middle" fill="#6b7280" font-size="12.5">（OpenAI 兼容）</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="635.0" y="700" text-anchor="middle" fill="#111827" font-size="15" font-weight="600">项目文件系统</text>
    <text x="635.0" y="722" text-anchor="middle" fill="#6b7280" font-size="12.5">（文件系统）</text>
  </g>
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 960 850" width="960" height="850" style="width:100%;max-width:960px;height:auto;">
  ...
  <text x="480" y="34" text-anchor="middle" fill="#111827" font-size="18" font-weight="600" data-graph-role="label">Mini Pi — 对话流程</text>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="84" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">启动 mini-pi</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="178" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">读取你的设置</text>
    <text x="480.0" y="198" text-anchor="middle" fill="#6b7280" font-size="12.5">（用哪个 AI 模型、存在哪）</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="272" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">你输入一句话</text>
    <text x="480.0" y="292" text-anchor="middle" fill="#6b7280" font-size="12.5">（提问，或「帮我修个 bug」）</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="366" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">把你的话发给 AI</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="460" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">AI 判断怎么处理</text>
    <text x="480.0" y="480" text-anchor="middle" fill="#6b7280" font-size="12.5">· 直接回答你</text>
    <text x="480.0" y="500" text-anchor="middle" fill="#6b7280" font-size="12.5">· 或先动手——读文件、改代码、跑命令、搜索</text>
    <text x="480.0" y="520" text-anchor="middle" fill="#6b7280" font-size="12.5">· 直到能回答为止</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="590" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">答案逐字显示</text>
    <text x="480.0" y="610" text-anchor="middle" fill="#6b7280" font-size="12.5">（随时可以打断它）</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="684" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">对话自动保存</text>
  </g>
  <g data-graph-role="node">
    ...
    <text x="480.0" y="778" text-anchor="middle" fill="#111827" font-size="14.5" font-weight="600">输入 /exit 退出</text>
    <text x="480.0" y="798" text-anchor="middle" fill="#6b7280" font-size="12.5">（下次回来接着聊）</text>
  </g>
